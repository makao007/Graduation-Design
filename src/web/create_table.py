...
cur.execute ("create table if not exists weburls  (id serial primary key, url varchar(1024) not null, title varchar(1000), last_modify char(20), download_time char(20), content text);"); 
